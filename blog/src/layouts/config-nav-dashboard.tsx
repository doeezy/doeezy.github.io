...
export const navData = [
  {
    subheader: '',
    items: [
      { title: 'JavaScript', path: paths.dashboard.root, icon: ICONS.dashboard },
      { title: 'Vue.js', path: paths.dashboard.general.ecommerce, icon: ICONS.ecommerce },
      { title: 'React', path: paths.dashboard.general.analytics, icon: ICONS.analytics },
      { title: 'Keycloak', path: paths.dashboard.general.banking, icon: ICONS.banking },
    ],
  },
  /**
   * Overview
